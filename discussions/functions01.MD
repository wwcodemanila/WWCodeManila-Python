...
Just some notes:
* Please use and copy [functions01.py](https://github.com/wwcodemanila/WWCodeManila-Python/blob/master/exercises/functions/functions01.py) as template. The ForEX list are there.
